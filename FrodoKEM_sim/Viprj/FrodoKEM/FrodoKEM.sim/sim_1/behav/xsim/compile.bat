...
REM
REM Generated by Vivado on Wed Apr 29 13:50:23 +0800 2026
...
echo "xvlog --incr --relax -prj tb_Frodo_top_vlog.prj"
call xvlog  --incr --relax -prj tb_Frodo_top_vlog.prj -log xvlog.log
