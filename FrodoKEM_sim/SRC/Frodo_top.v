...
//--------------------------------------------------------数据通路连线
    ...
    //--输出数据线
        ...
        always@(*)begin
            case(doutsel)
                2'b00: dout = 64'd0;
                2'b01: dout = dout_ram64a0; 
                2'b10: dout = dout_ram64b0;
                2'b11: dout = fifo_data_64_out;
            endcase
        end
        //--pack
        always@(*)begin
        ...
        always@(*)begin
            case(add_insel)
                ...
                2'b11:begin add_ina = 64'd0    ; add_inb = 64'd0        ;end
            endcase
        end
...
dram64_r#(
    ...
    .DATA_WIDTH ( 64 ),
    .MEM_DEPTH  ( 3000 ),
    .HEX_FILE   ( "D:/Work_prj/Frodokem_2026/TB/RAM64a.hex" ),
    .OUTPUT_FILE ( "D:/Work_prj/Frodokem_2026/TB/RAM64aout.hex" )
)ram64a(
    .clk        ( clk        ),
    .rstn       ( rstn       ),
    .dump_en    ( dump_en    ),
...
dram64_r#(
    ...
    .DATA_WIDTH ( 64 ),
    .MEM_DEPTH  ( 3000 ),
    .HEX_FILE   ( "D:/Work_prj/Frodokem_2026/TB/RAM64b.hex" ),
    .OUTPUT_FILE ( "D:/Work_prj/Frodokem_2026/TB/RAM64bout.hex" )
)ram64b(
    .clk        ( clk        ),
    .rstn       ( rstn       ),
    .dump_en    ( dump_en    ),
...
dram448_r#(
    ...
    .DATA_WIDTH ( 448 ),
    .MEM_DEPTH  ( 800 ),
    .HEX_FILE   ( "D:/Work_prj/Frodokem_2026/TB/RAM448.hex"  ),
    .OUTPUT_FILE ( "D:/Work_prj/Frodokem_2026/TB/RAM448out.hex" )
)ram448(
    .clk        ( clk        ),
    .rstn       ( rstn       ),
    .dump_en    ( dump_en    ),
...
RAM448 uRAM448 (
  .clka(clk),    // input wire clka
  .ena(1'b1),      // input wire ena
  .wea(we_ram4480),      // input wire [0 : 0] wea
