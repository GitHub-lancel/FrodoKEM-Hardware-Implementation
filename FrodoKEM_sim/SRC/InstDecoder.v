...
//--------------------------------------------------定义信号
    ...
    parameter   F640kg1  = 10'd33;

    parameter   F640ec0  = 10'd34;
    parameter   F640ec1  = 10'd86;

    parameter   F640dc0  = 10'd87;
    parameter   F640dc1  = 10'd158;

    parameter   F976kg0  = 10'd159;
    parameter   F976kg1  = 10'd187;

    parameter   F976ec0  = 10'd188;
    parameter   F976ec1  = 10'd228;

    parameter   F976dc0  = 10'd229;
    parameter   F976dc1  = 10'd284;

    parameter   F1344kg0 = 10'd285;
    parameter   F1344kg1 = 10'd312;

    parameter   F1344ec0 = 10'd313;
    parameter   F1344ec1 = 10'd353;

    parameter   F1344dc0 = 10'd354;
    parameter   F1344dc1 = 10'd409;
    ...
    assign width448 = inst_all[1];
    assign bool     = inst_all[0];
...
//--------------------------------------------------2.指令地址控制
    ...
    always@(*)begin
        case({lvl,mode})
            4'b0101:idle_addr = F640kg0;
            4'b0110:idle_addr = F640ec0;
            4'b0111:idle_addr = F640dc0;
            4'b1001:idle_addr = F976kg0;
            4'b1010:idle_addr = F976ec0;
            4'b1011:idle_addr = F976dc0;
            4'b1101:idle_addr = F1344kg0;
            4'b1110:idle_addr = F1344ec0;
            4'b1111:idle_addr = F1344dc0;
...
dual_ram_asyn#(
    ...
    .DATA_WIDTH ( 16 ),
    .MEM_DEPTH  ( 64 ),
    .HEX_FILE   ( "D:/Work_prj/Frodokem_2026/Addr.hex" ),
    .OUTPUT_FILE (  )
)addrom(
    .clk        ( clk        ),
    .rstn       ( rstn       ),
...
dual_ram#(
    ...
    .DATA_WIDTH ( 36 ),
    .MEM_DEPTH  ( 1024 ),
    .HEX_FILE   ( "D:/Work_prj/Frodokem_2026/Inst.hex" ),
    .OUTPUT_FILE (  )
)u_dual_ram(
    .clk        ( clk        ),
    .rstn       ( rstn       ),
