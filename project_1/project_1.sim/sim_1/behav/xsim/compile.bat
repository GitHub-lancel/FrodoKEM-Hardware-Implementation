...
REM
REM Generated by Vivado on Tue Apr 14 16:25:19 +0800 2026
...
echo "xvlog --incr --relax -prj Frodo_top_vlog.prj"
call xvlog  --incr --relax -prj Frodo_top_vlog.prj -log xvlog.log
