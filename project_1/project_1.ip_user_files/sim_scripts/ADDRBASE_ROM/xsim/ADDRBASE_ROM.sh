...
#
# Script generated by Vivado on Tue Apr 14 16:33:25 +0800 2026
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ADDRBASE_ROM.sh
...
#
# Usage        : ADDRBASE_ROM.sh
#                ADDRBASE_ROM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ADDRBASE_ROM.sh [-reset_run]
#                ADDRBASE_ROM.sh [-reset_log]
#                ADDRBASE_ROM.sh [-help]
#
...
export RDI_DATADIR="D:/Xlinx/2025.1/Vivado/data"

# set xvlog options
xvlog_opts="--incr --relax "

# script info
echo -e "ADDRBASE_ROM.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ADDRBASE_ROM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L dist_mem_gen_v8_0_17 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ADDRBASE_ROM xil_defaultlib.ADDRBASE_ROM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ADDRBASE_ROM -key {Behavioral:sim_1:Functional:ADDRBASE_ROM} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Xlinx/2025.1/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ADDRBASE_ROM.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ADDRBASE_ROM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ADDRBASE_ROM.sh [-help]\n\
Usage: ADDRBASE_ROM.sh [-step]\n\
Usage: ADDRBASE_ROM.sh [-lib_map_path]\n\
Usage: ADDRBASE_ROM.sh [-reset_run]\n\
Usage: ADDRBASE_ROM.sh [-reset_log]\n\
Usage: ADDRBASE_ROM.sh [-keep_index]\n\
Usage: ADDRBASE_ROM.sh [-noclean_files]\n\n\
