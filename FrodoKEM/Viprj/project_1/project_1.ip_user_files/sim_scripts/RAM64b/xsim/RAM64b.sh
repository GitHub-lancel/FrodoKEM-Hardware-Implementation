...
#
# Script generated by Vivado on Wed Apr 29 14:54:02 +0800 2026
...
#
# Usage        : RAM64b.sh
#                RAM64b.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                RAM64b.sh [-reset_run]
#                RAM64b.sh [-reset_log]
#                RAM64b.sh [-help]
#
...
# script info
echo -e "RAM64b.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./RAM64b.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RAM64b xil_defaultlib.RAM64b xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim RAM64b -key {Behavioral:sim_1:Functional:RAM64b} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb RAM64b.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./RAM64b.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: RAM64b.sh [-help]\n\
Usage: RAM64b.sh [-step]\n\
Usage: RAM64b.sh [-lib_map_path]\n\
Usage: RAM64b.sh [-reset_run]\n\
Usage: RAM64b.sh [-reset_log]\n\
Usage: RAM64b.sh [-keep_index]\n\
Usage: RAM64b.sh [-noclean_files]\n\n\
