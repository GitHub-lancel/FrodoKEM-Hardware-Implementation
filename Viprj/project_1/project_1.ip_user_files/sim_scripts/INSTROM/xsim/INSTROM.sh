...
#
# Script generated by Vivado on Mon May 04 17:34:22 +0800 2026
...
# script info
echo -e "INSTROM.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot INSTROM xil_defaultlib.INSTROM xil_defaultlib.glbl -log elaborate.log
}
