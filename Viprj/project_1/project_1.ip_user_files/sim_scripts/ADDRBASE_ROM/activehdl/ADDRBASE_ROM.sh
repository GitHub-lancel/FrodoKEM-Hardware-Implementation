...
#                script (type 'ADDRBASE_ROM.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Frodokem_2026_tx/FrodoKEM/Viprj/project_1/project_1.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
